...
Server b' b = Proxy X () b' b 

-- | Like 'Effect', but with a polymorphic type
-- type Effect' m r = forall x' x y' y . Proxy x' x y' y m r
Effect' : (Type -> Type) -> Type -> Type
Effect' = Proxy Type Type Type Type
-- Effect' = Proxy x' x y' y
-- Effect' m r = Proxy _ _ _ _ m r
...
fb' >\\ p = case p of
                 ...
                 Respond x  fx' => Respond x (\x' => fb' >\\ (fx' x'))
